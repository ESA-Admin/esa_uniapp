...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"esa_uniapp_demo","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 4 */
/*!*************************************************!*\
  !*** E:/Project/HBuilder/esa_uniapp/pages.json ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 11 */
/*!****************************************************!*\
  !*** E:/Project/HBuilder/esa_uniapp/esa/common.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var _config = _interopRequireDefault(__webpack_require__(/*! @/static/config.json */ 12));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

var esa = {
  url: function url(action) {
    if (action.indexOf("/") === 0) {
      return _config.default.url + action + ".html?PLATFORM_ID=" + _config.default.pfid;
    } else if (action.indexOf("http://") === 0 || action.indexOf("https://") === 0) {
      return action;
    }
    var url = _config.default.url + "/addons/" + _config.default.pfid + "/" + _config.default.addon + "." + action + ".html";
    return url;
  },
  request: function request(options, _success, error) {
    ...
    var param = Object.assign({
      ...
      success: function success(res) {
        ...
        try {
          ...
          if (typeof res !== "object") _success.call(this, res, res);
        } catch (e) {
        ...
        if (res.code === 10004 && uni.getStorageSync("wxappUserInfo")) {
          ...
          if (typeof _success === 'function') {
            var result = _success.call(this, data, res);
            if (result === false)
            return;
          }
          if (msg !== "") {
  ...
  checkToken: function checkToken(success, error) {
    console.log("校验TOKEN");
    esa.request({
  ...
  getEsaUser: function getEsaUser(callback, code) {
  ...
  upgradeUser: function upgradeUser(wxappUserInfo, callback) {
  ...
  login: function login(callback, wxappUserInfo) {var secound = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    console.log("开始登陆");
  ...
  getUserInfo: function getUserInfo(callback, wxappUserInfo) {
...
/* 12 */
/*!*********************************************************!*\
  !*** E:/Project/HBuilder/esa_uniapp/static/config.json ***!
  \*********************************************************/
/*! exports provided: debug, url, pfid, addon, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"debug\":true,\"url\":\"https://dev.esaadmin.com\",\"pfid\":38,\"addon\":\"index\"}");
